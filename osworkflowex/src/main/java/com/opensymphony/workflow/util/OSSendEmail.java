...
public class OSSendEmail implements FunctionProvider {
    ...
    private static final Log log = LogFactory.getLog(OSSendEmail.class);
    ...
    public void execute(Map transientVars, Map args, PropertySet ps) {
        ...
        try {
            ...
            Session sendMailSession = Session.getInstance(props, new MyAuthenticator(username, password));
