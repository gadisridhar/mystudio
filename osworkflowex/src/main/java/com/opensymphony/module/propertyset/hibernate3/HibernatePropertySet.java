...
public class HibernatePropertySet extends AbstractPropertySet {
    ...
    {
        log.debug("(HibernatePropertySet) top of init."); //$NON-NLS-1$

        super.init(config, args);
        this.entityId = (Long) args.get("entityId"); //$NON-NLS-1$
        this.entityName = (String) args.get("entityName"); //$NON-NLS-1$
    ...
    protected void setImpl(int type, String key, Object value) throws PropertyException
    {
        ...
        {
            throw new PropertyException("Existing key '" + key + "' does not have matching type of " + type);//$NON-NLS-1$ //$NON-NLS-2$
        }
    ...
    protected Object get(int type, String key) throws PropertyException
    {
        ...
        {
            throw new PropertyException("key '" + key + "' does not have matching type of " + type); //$NON-NLS-1$ //$NON-NLS-2$
        }
