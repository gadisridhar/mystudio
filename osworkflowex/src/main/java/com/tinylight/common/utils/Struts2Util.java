 ...
 * Struts2 Util籄1�7.
 * 
 * 实现获取Request/Response/Session与绕过jsp/freemaker直接输出文本的简化函敄1�7.
 * 
 */
public class Struts2Util {
	...
	// 取得Request/Response/Session的简化函敄1�7 //

	/**
	 * 取得HttpSession的简化方泄1�7.
	 */
	...
	/**
	 * 取得Request Parameter的简化方泄1�7.
	 */
	public static String getParameter(String name) {
		return getRequest().getParameter(name);
	}

	// 绕过jsp/freemaker直接输出文本的函敄1�7 //
	 ...
	 * 
	 * @param headers 可变的header数组，目前接受的值为"encoding:"戄1�7"no-cache:",默认值分别为UTF-8和true.                 
	 */
		...
		try {
			...
			for (String header : headers) {
				...
				if (StringUtils.equalsIgnoreCase(headerName, ENCODING_PREFIX)) {
					...
					throw new IllegalArgumentException(headerName + "不是丄1�7个合法的header类型");
			}
	 ...
	 * 直接输出JSON.
	 * 
	 * @param map Map对象,将被转化为json字符丄1�7.
	 * @see #render(String, String, String...)
	 */
	 ...
	 * 直接输出JSON.
	 * 
	 * @param object Java对象,将被转化为json字符丄1�7.
	 * @see #render(String, String, String...)
	 */
