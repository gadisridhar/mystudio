...
public class ConverterHelper {
     ...
     */
    private Logger log = LoggerFactory.getLogger(ConverterHelper.class);
...
//    public Tuple convert(Object value1, Object value2) {
//
//        if (value1 == null || value2 == null) {
//            return new Tuple(value1, value2, null);
//        }
//        if (value1 instanceof String) {
//            return new Tuple(value1, value2.toString(), null);
//        }
//
//        if (value1 instanceof Number || value2 instanceof Number) {
//            value1 = this.convert(BigDecimal.class, value1);
//            value2 = this.convert(BigDecimal.class, value2);
//
//            return new Tuple(value1, value2, null);
//        }
//
        ...
        register(java.util.Date.class, new DateConverter() {
            ...
            public Object convert(Class type, Object value) {
                ...
                if (value == null) {
                    ...
                    if (strVal.contains("/")) {
                        return convertToDate(type, strVal, "yyyy/MM/dd HH:mm:ss");
                    } else {
                        return convertToDate(type, strVal, "yyyy-MM-dd HH:mm:ss");
                    }
                    ...
                    String strVal = value.toString();
                    if (strVal.contains("/")) {
                        return convertToDate(type, strVal, "yyyy/MM/dd");
                    } else {
                        return convertToDate(type, strVal, "yyyy-MM-dd");
                    }
