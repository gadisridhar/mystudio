...
public final class Operation {
    ...
    Object eval(VariableProvider variables) {
    ...
    private Object evaluateOperand(Object operand,
            VariableProvider variables) {
        if (operand instanceof Operation) {
            return ((Operation) operand).eval(variables);
        } else if (operand instanceof String) {
            Object value;
            if (variables == null || (value = variables.getVar((String) operand)) == null) {
            ...
            return ((StringValue) operand).getValue();
