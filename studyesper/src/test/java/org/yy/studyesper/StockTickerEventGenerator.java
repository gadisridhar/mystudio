...
public class StockTickerEventGenerator implements StockTickerRegressionConstants
{
    private Random random = new Random(System.currentTimeMillis());;

    public LinkedList<Object> makeEventStream(int numberOfTicks, int ratioOutOfLimit, int numberOfStocks)
    {
